...
# Encoders
# Embed the input sequence into a sequence of vectors 将输入序列嵌入到矢量序列中
...
# Embed the input into a sequence of vectors of size query_maxlen 将输入嵌入到大小query_maxlen的向量序列中
